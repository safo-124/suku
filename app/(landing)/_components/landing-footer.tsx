      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Modern school management for the digital age. Empowering educators and students across Africa.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* X (formerly Twitter) */}
            <a href="#" className="text-muted-foreground hover:text-foreground transition-colors" aria-label="X (formerly Twitter)">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
